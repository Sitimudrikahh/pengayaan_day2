...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-danger text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">SM</a>
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form action="" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                <input name="nama" class="form-control" id="name" type="text" placeholder="Enter your name..." data-sb-validations="required" />
                            ...
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                                <textarea name="pesan" class="form-control" id="message" type="text" placeholder="Enter your message here..." style="height: 10rem" data-sb-validations="required"></textarea>
                            ...
                            <!-- Submit Button-->
                            <button class="btn btn-primary btn-xl disabled" id="submitButton" type="submit" name="kirim">Send</button>
                        </form>
                    </div>
                </div>
            </div>
